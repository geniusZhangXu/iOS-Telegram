...
public final class ThreadPoolTask {
    fileprivate let state = ThreadPoolTaskState()
    fileprivate let action: (ThreadPoolTaskState) -> ()
...
public final class ThreadPoolQueue : Equatable {
    fileprivate weak var threadPool: ThreadPool?
    fileprivate var tasks: [ThreadPoolTask] = []
...
@objc public final class ThreadPool: NSObject {
    ...
    fileprivate var queues: [ThreadPoolQueue] = []
    fileprivate var takenQueues: [ThreadPoolQueue] = []
