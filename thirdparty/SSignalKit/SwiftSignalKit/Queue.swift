...
public final class Queue {
    fileprivate let nativeQueue: DispatchQueue
    fileprivate var specific = NSObject()
    fileprivate let specialIsMainQueue: Bool
    ...
    public func justDispatchWithQoS(_ qos: DispatchQoS, _ f: @escaping () -> Void) {
