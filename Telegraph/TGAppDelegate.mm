...
- (TGNavigationController *)loginNavigationController{
    ...
    if (_loginNavigationController == nil){
        ...
        // 按照它这里的想法，是想在这里区分一下模拟机和真机，要是是模拟机，就走下面的TGLoginWelcomeController
        // 要是是真机的话就走下面的 RMIntroViewController
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    //****************配置友盟参数后调用此方法初始化SDK！
    UMConfigInstance.appKey = @"58e600bf2ae85b604b000dff";
    //应用的推广渠道,channelId为nil或@""时，默认会被当作@"App Store"渠道。
